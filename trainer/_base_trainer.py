...
class BaseTrainer():
    ...
    def save_checkpoint(self):
        if self.master:
            ...
            if isinstance(self.cfg.data.cls_names, list) and len(self.cfg.data.cls_names) == 1:
                cls_name = self.cfg.data.cls_names[0]
                torch.save(checkpoint_info, f'{self.cfg.logdir}/ckpt_{cls_name}.pth')
                torch.save(checkpoint_info['net'], f'{self.cfg.logdir}/net_{cls_name}.pth')
